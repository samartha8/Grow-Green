  ...
  const handleFinalSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload = {
        ...
        age: 25,
        hasStartedMenstruating: formData.hasStartedMenstruating === "yes",
        lastPeriodDate:
        ...
        cycleLength:
          formData.hasStartedMenstruating === "yes"
            ? parseInt(formData.cycleLength)
            : undefined,
        notificationSettings: {
          periodReminders: true,
          fertilityWindowReminders: true,
        },
        privacyMode: false,
      };
      ...
      const hasStarted = payload.hasStartedMenstruating;
      const completedOnboarding =
        hasStarted && payload.lastPeriodDate && payload.cycleLength;

      navigate(completedOnboarding ? "/dashboard" : "/onboarding");
    } catch (err: any) {
      toast({
        title: "Signup Failed",
        description:
        ...
        <Card className="border-0 shadow-2xl bg-white/90 backdrop-blur-sm">
          <CardHeader className="text-center pb-2">
            ...
            <p className="text-gray-600">
              {step === 1
                ? "Join your compassionate wellness companion"
            ...
            {step === 1 ? (
              ...
              <form onSubmit={handleFinalSubmit} className="space-y-4">
                <div className="bg-rose-50 p-4 rounded-lg mb-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h3 className="font-semibold text-rose-800">
                      Period Tracking Setup
                    </h3>
                  </div>
                  <p className="text-sm text-rose-700">
                    This information helps us provide personalized tracking and
                    predictions. All data is kept private and secure.
                  </p>
                </div>
                    ...
                    <label className="flex items-center gap-2">
                      <input
                        ...
                        onChange={(e) =>
                          setFormData({
                            ...formData,
                            hasStartedMenstruating: e.target.value,
                          })
                        }
                ...
                {formData.hasStartedMenstruating === "yes" && (
                  <>
                    <div className="space-y-2">
                      <Label htmlFor="lastPeriod" className="text-gray-700">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="cycleLength" className="text-gray-700">
                      ...
                      />
                      <p className="text-xs text-gray-500">
                        Most cycles are between 21-35 days. Don't worry if
                        you're not sure, you can update this later.
                      </p>
                    </div>
                  </>
                )}
                ...
                {formData.hasStartedMenstruating === "no" && (
                  <div className="bg-purple-50 p-4 rounded-lg">
                    <p className="text-sm text-purple-700">
                      No worries! CHORI will help you prepare for your first
                      period with educational resources and support. You can
                      update your tracking information once your period starts.
                    </p>
                  </div>
                )}
